...
if __name__ == '__main__':
    port = int(os.environ.get('PORT', 5000))  # Render asigna un puerto al azar, usamos ese
    app.run(host='0.0.0.0', port=port)  # Es necesario escuchar en 0.0.0.0 para que Render lo detecte
